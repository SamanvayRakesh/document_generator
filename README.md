# document_generator
An API-integrated project that can generate a text document using AI and save it directly to your files or folders
...
topic = input("Enter the document topic:\n> ")
generate_document(topic)

print("Document generated: output.docx")
